...
```bash
# Create source directory and cd into it
...
#### 3. Download Device Trees
```bash
git clone https://github.com/turtleletortue/android_device_bn_st18c7bnn ~/android/lineage/device/bn/st18c7bnn
git clone https://github.com/turtleletortue/android_vendor_bn_st18c7bnn ~/andorid/lineage/vendor/bn/st18c7bnn
```
...
brunch lineage_st18c7bnn-userdebug
```
